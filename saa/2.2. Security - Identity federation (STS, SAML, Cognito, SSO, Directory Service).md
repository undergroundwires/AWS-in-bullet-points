...
- **Web Identity Federation** is an alternative to Cognito but AWS recommeds Web Identity Federation only for advanced scenarios. Mostly try to use Cognito, because it does most of the behind-the-scenes work with public identity provider services for you.
